...
function activateLoginToggleAndShowLoginForm(){
    ...
    mainContainer.children[1].textContent = 'You are back! Login to continue smeshing your goals';
}
...
toggleContainer.addEventListener('click', function(e){
    ...
    if(clicked === toggleSignup){
        if(signUpForm.style.transform = `translate(0, 0)`){
            ...
            // change <h2> on page to login text
            mainContainer.children[1].textContent = 'Begin smeshing your goals, fill in the fields below to create an account'
        }
    }
})